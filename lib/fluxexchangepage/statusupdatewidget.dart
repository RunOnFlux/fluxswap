...
import 'package:fluxswap/api/requests.dart'; // Assuming you have a fetchSwapStatus method defined here
import 'dart:convert';
...
class _StatusUpdateWidgetState extends State<StatusUpdateWidget> {
  ...
  void _updateStatus() async {
    ...
    try {
      SwapResponse swap = await fetchSwapStatus(widget.swapId);
